  ...
  return (
    <nav className="bg-white bg-blend-color-burn shadow-sm py-4 sticky top-0 z-50">
      <div className="container-custom mx-auto flex justify-between items-center">
        ...
        <img src ="/logo.png" className="w-12 h-12 mr-3" />
        <p className='text-gray-700'>PRETORIA WEST AND BEYOND PASTORS FORUM</p>
        </a>
        ...
        <a href="/#hero" className="text-gray-700 hover:text-blue-700 transition-colors">Home</a>
          ...
          <a href="#events" className="text-gray-700 hover:text-blue-700 transition-colors">Events</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-white p-4 shadow-inner">
          <div className="flex flex-col space-y-4">
            ...
            <a href="#events" className="text-gray-700 hover:text-blue-700 transition-colors py-2 border-b">Events</a>
            <a href="/gallery" className="text-gray-700 hover:text-blue-700 transition-colors py-2 border-b">Gallery</a>
